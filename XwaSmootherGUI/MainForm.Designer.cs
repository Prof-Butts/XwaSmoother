namespace XwaSmoother
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.inputFileTextBox.Size = new System.Drawing.Size(648, 20);
			this.inputFileTextBox.TabIndex = 0;
			// 
			// inputFileButton
			// 
			this.inputFileButton.Location = new System.Drawing.Point(666, 22);
			...
			// outputFileButton
			// 
			this.outputFileButton.Location = new System.Drawing.Point(666, 67);
			...
			this.outputFileTextBox.Size = new System.Drawing.Size(648, 20);
			...
			this.thresholdsTextBox.Size = new System.Drawing.Size(648, 52);
			...
			this.label3.Size = new System.Drawing.Size(648, 13);
			this.label3.TabIndex = 7;
			this.label3.Text = "Thresholds. Mesh indices/ranges followed by a colon and angle (e.g. 0,1,5..8:40)." +
    " Use -1 to apply the threshold to all meshes (e.g. -1:25)";
			// 
			// smoothButton
			// 
			this.smoothButton.Location = new System.Drawing.Point(666, 121);
			...
			this.overwriteCheckBox.Location = new System.Drawing.Point(666, 98);
			...
			// applyThrButton
			// 
			this.applyThrButton.Location = new System.Drawing.Point(666, 150);
			...
			this.applyThrButton.Visible = false;
